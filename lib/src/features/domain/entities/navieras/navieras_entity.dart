...
class NavierasEntity {
  NavierasEntity({
    required this.navieras,
  });

  final List<NavierasDetailEntity>? navieras;

  factory NavierasEntity.fromJson(String str) =>
      NavierasEntity.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory NavierasEntity.fromMap(Map<String, dynamic> json) => NavierasEntity(
        navieras: json["navieras"] == null
            ? null
            : List<NavierasDetailEntity>.from(
                json["navieras"].map((x) => NavierasDetailEntity.fromMap(x))),
      );
...
class NavierasDetailEntity {
  NavierasDetailEntity({
    required this.navi,
  ...
  factory NavierasDetailEntity.fromJson(String str) =>
      NavierasDetailEntity.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory NavierasDetailEntity.fromMap(Map<String, dynamic> json) =>
      NavierasDetailEntity(
        navi: json["navi"],
