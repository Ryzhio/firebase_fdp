...
class ClienListDecodable {
  ClienListDecodable({
    required this.clienList,
  });

  List<ClienList>? clienList;
  factory ClienListDecodable.fromJson(String str) =>
      ClienListDecodable.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory ClienListDecodable.fromMap(Map<String, dynamic> json) =>
      ClienListDecodable(
        clienList: json["clienList"] == null
            ? null
            : List<ClienList>.from(
                json["clienList"].map((x) => ClienList.fromMap(x))),
      );
...
class ClienList {
  ...
  factory ClienList.fromJson(String str) => ClienList.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory ClienList.fromMap(Map<String, dynamic> json) => ClienList(
