...
class NaviListDecodable {
  NaviListDecodable({
    required this.naviList,
  });

  List<NaviList>? naviList;
  factory NaviListDecodable.fromJson(String str) =>
      NaviListDecodable.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory NaviListDecodable.fromMap(Map<String, dynamic> json) =>
      NaviListDecodable(
        naviList: json["naviList"] == null
            ? null
            : List<NaviList>.from(
                json["naviList"].map((x) => NaviList.fromMap(x))),
      );
...
class NaviList {
  ...
  factory NaviList.fromJson(String str) => NaviList.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory NaviList.fromMap(Map<String, dynamic> json) => NaviList(
